...
struct Object : public cxxtools::Connectable
{
	bool method(int val)
	{
		std::cout << "Object::method called. val=" << val << std::endl;
		return true;
	}
...
int main(int argc, char* argv[])
{
	try
	{
		...
		cxxtools::Signal<int> signalEventNo;

		signalEventNo.connect( cxxtools::slot(obj, &Object::method) );

		signalEventNo.send(111);
	}
